...
sigres_KGN_15an_vs_control <- res_KGN_15an_vs_control[which(res_KGN_15an_vs_control$padj < 0.05 & abs(res_KGN_15an_vs_control$log2FoldChange) > 1), ]
sigres_KGN_15a_vs_control <- res_KGN_15a_vs_control[which(res_KGN_15a_vs_control$padj < 0.05 & abs(res_KGN_15a_vs_control$log2FoldChange) > 1), ]
sigres_KGN_15c_vs_control <- res_KGN_15c_vs_control[which(res_KGN_15c_vs_control$padj < 0.05 & abs(res_KGN_15c_vs_control$log2FoldChange) > 1), ]
...
sigres_MHCC_15an_vs_control <- res_MHCC_15an_vs_control[which(res_MHCC_15an_vs_control$padj < 0.05 & abs(res_MHCC_15an_vs_control$log2FoldChange) > 1), ]
sigres_MHCC_15a_vs_control <- res_MHCC_15a_vs_control[which(res_MHCC_15a_vs_control$padj < 0.05 & abs(res_MHCC_15a_vs_control$log2FoldChange) > 1), ]
sigres_MHCC_15c_vs_control <- res_MHCC_15c_vs_control[which(res_MHCC_15c_vs_control$padj < 0.05 & abs(res_MHCC_15c_vs_control$log2FoldChange) > 1), ]

gene_ids_15an <- rownames(sigres_MHCC_15an_vs_control)
gene_ids_15a <- rownames(sigres_MHCC_15a_vs_control)
gene_ids_15c <- rownames(sigres_MHCC_15c_vs_control)
common_genes <- intersect(intersect(gene_ids_15an, gene_ids_15a), gene_ids_15c)


res <- res_MHCC_15an_vs_control[order(res_MHCC_15an_vs_controll$pvalue), ]######此处进行替换
